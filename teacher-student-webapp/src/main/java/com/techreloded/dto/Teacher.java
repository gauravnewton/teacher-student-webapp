...
public class Teacher {
	 ...
	 */
	public Teacher(long id, String firstName, String lastName, String email, String password, String gender,
			String phone, Date createdOn, String createdBy, Date updatedOn, String updatedBy, String roleCode,
			String status) {
		super();
		this.id = id;
		this.firstName = firstName;
