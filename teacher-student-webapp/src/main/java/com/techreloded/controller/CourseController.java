...
public class CourseController {
	...
	@RequestMapping(value = "/updateCourse", produces = {MediaType.APPLICATION_JSON_VALUE}, method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> updateCourse( @RequestBody Course courseRequest, HttpServletRequest request){
		Map<String, Object> response = new HashMap<>();
		try {			
			Teacher teacherContext = (Teacher) request.getSession().getAttribute("teacherContext");
			if( Objects.isNull(teacherContext) ) {
				...
				int studentId = courseService.updateCourse(courseRequest, teacherContext.getFirstName() +" "+ teacherContext.getLastName());
	...
	@RequestMapping(value = "/getAllCourses", produces = {MediaType.APPLICATION_JSON_VALUE}, method = RequestMethod.GET)
	...
	public @ResponseBody Map<String, Object> getCourseById( @PathVariable("courseId") String courseId, HttpServletRequest request){
		Map<String, Object> response = new HashMap<>();
		try {
	...
	@RequestMapping(value = "/analyseEnrollmentEligilibity/{courseId}/{studentId}", produces = {MediaType.APPLICATION_JSON_VALUE}, method = RequestMethod.GET)
	public @ResponseBody Map<String, Object> analyseEnrollmentEligilibity( @PathVariable("courseId") String courseId, @PathVariable("studentId") String studentId, HttpServletRequest request){
		Map<String, Object> response = new HashMap<>();
		try {
			List<StudentCourseEnrollment> course = courseService.getEnrollmentByCourseIdAndStudentId(courseId, studentId);			
			if( course.isEmpty() ) {
				response.put(AppConstant.DATA, null);
				response.put(AppConstant.IS_SUCCESS, true);
	...
	@RequestMapping(value = "/getEnrolledCourses/{studentId}", produces = {MediaType.APPLICATION_JSON_VALUE}, method = RequestMethod.GET)
	public @ResponseBody Map<String, Object> getEnrolledCourses( @PathVariable("studentId") String studentId, HttpServletRequest request){
		Map<String, Object> response = new HashMap<>();
		try {
	...
	@RequestMapping(value = "/enroll/{courseId}/{studentId}", produces = {MediaType.APPLICATION_JSON_VALUE}, method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> enroll( @PathVariable("courseId") String courseId, @PathVariable("studentId") String studentId, HttpServletRequest request){
		Map<String, Object> response = new HashMap<>();
		try {
